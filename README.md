# Olá! 👋 Eu sou o Matheus C Risatti
...
#### 🏥 Clínica Financeira (BarraCred)
* **O que é:** Plataforma de educação financeira e consultoria para cooperados.
* **Objetivo:** Agilizar e automatizar o processo de triagem e agendamento das consultorias, além de facilitar a coleta e o acesso a estatísticas cruciais sobre os atendimentos realizados na clínica.
* **Meu Papel:** Atuação no desenvolvimento FullStack e estruturação do fluxo do projeto.

#### 🛡️ Aventura Segura
* **O que é:** Aplicativo informativo focado na prevenção de queimaduras infantis.
* **Objetivo:** Promover a educação e a segurança das crianças por meio da tecnologia, unindo a lógica de programação com o impacto e a conscientização social.
